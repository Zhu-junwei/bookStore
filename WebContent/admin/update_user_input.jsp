...
<body>
	<div id="page-main" style="backgroud:#104d74;">
		...
		<form class="form-horizontal" method="post" action="Admin_updateUser">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input required name="user.username" type="text" class="form-control" id="username"
						value="<s:property value="user.username"/>"> <span class="text-danger"><s:property
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input required name="user.email" type="email" class="form-control" id="email"
						value="<s:property value="user.email"/>"> <span id="emailError"
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input required name="user.phone" type="text" class="form-control" id="phone"
						value="<s:property value="user.phone"/>"> <span id="phoneError"
						class="text-danger"></span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input name="user.zipcode" type="text" class="form-control" id="zipcode"
						value="<s:property value="user.zipcode"/>"> <span id="zipcodeError"
						class="text-danger"></span>
				</div>
			</div>
