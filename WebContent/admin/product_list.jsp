...
<body>
	<div id="page-main" style="backgroud:#104d74;">
		...
		<nav>
			<ul class="pager">
				<li><a href="Admin_listAllProductByPage?p=1">首页</a>
				</li>
				<s:if test="page.currentPage > 1">
				<li><a href="Admin_listAllProductByPage?p=<s:property value="page.currentPage-1" />">上一页</a>
				</li>
				</s:if>
				
				<s:if test="page.currentPage < page.totalPage">
				<li><a href="Admin_listAllProductByPage?p=<s:property value="page.currentPage+1" />">下一页</a>
				</li>
				</s:if>
				<li><a href="Admin_listAllProductByPage?p=<s:property value="page.totalPage" />">尾页</a>
				</li>
			</ul>
		</nav>
	</div>
